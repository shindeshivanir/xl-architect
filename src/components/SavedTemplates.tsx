  ...
  return (
    <div className="w-full max-w-5xl">
      <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden min-h-[60vh] flex flex-col transition-colors">
        {/* Header */}
        <div className="bg-[#217346] dark:bg-[#1a5c38] p-8 md:p-12 text-white relative overflow-hidden transition-colors">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-3xl font-black tracking-tight">Visual Templates</h2>
                  <p className="text-green-100/80 font-medium tracking-wide">Your library of pre-engineered data structures.</p>
                </div>
              </div>
              {onClose && (
                <button
            ...
            <div className="mt-8 relative max-w-2xl group">
              ...
              <input
                ...
                placeholder="Search templates by name or chart type..."
                className="w-full bg-green-900/40 backdrop-blur-md border-2 border-white/20 rounded-2xl py-5 pl-14 pr-14 text-lg text-white placeholder:text-green-200/50 focus:border-white transition-all outline-none"
              />
